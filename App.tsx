                  ...
                  <section className="space-y-3">
                    ...
                    <div className="space-y-4 rounded-xl border border-slate-800 bg-slate-900 p-4 text-[11px] leading-relaxed text-slate-400">
                      ...
                      <div>
                        ...
                        <p>2v2 tournament events use an eight-pair bracket. Each team starts with two pair entries, creating eight total pairs.</p>
                        <p className="mt-2">Every 2v2 tournament starts in the quarterfinals. The quarterfinal pairs are <span className="font-bold text-white">fixed before the event starts</span>, and the app shows the exact pairings on the Schedule.</p>
                        <p className="mt-2">Because each team has two pair entries, both pairs from the same team can win their quarterfinal games. If that happens, those two entries may play each other in the semifinal.</p>
        ...
        <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/92 px-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-[28px] border border-slate-700 bg-[linear-gradient(145deg,rgba(15,23,42,0.98)_0%,rgba(2,6,23,0.98)_100%)] p-5 shadow-2xl">
            <div className="mb-4 text-center">
              <div>
                <div className="text-[10px] font-black uppercase tracking-[0.18em] text-emerald-400">Welcome, {currentUser.name}</div>
